...
export const contactList = [
  [<HiOutlineMail size={30} style={{ color: "#ecedf3" }} />, "hello@renzgranados.com"],
  [<BsTelephone size={25} style={{ color: "#ecedf3" }} />, "+63 917 685 6069"],
];
//
...
const socClass =
  "w-[160px] h-[60px] flex items-center justify-center ml-[-100px] hover:ml-[-10px] duration-300 text-[#ecedf3]";
